 ...
 * {@link Eula#show(android.app.Activity)} in the onCreate() method of the first activity. If the user accepts the EULA, it will never be shown again.
 * If the user refuses, {@link android.app.Activity#finish()} is invoked on your activity.
 */
class Eula {
